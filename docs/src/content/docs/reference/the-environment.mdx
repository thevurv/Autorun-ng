...
Autorun-ng scripts run in special environments. That's where `Autorun` comes from. If you don't know what that is - read the [lua-api](/reference/lua-api) page.
...
To see documentation on what is stored in the environment and on the Autorun object, see the [lua-api](/reference/lua-api) page.
